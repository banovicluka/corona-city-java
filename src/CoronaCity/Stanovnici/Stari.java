...
public class Stari extends Stanovnik implements Serializable {

    public static int brojStarih;

    public Stari(){
        super();
    }

    public Stari(String ime,String prezime,int godinaRodjenja,String pol,int idKuce){
